...
<body>
    ...
    <form action="{{ route('articles.store') }}" method="POST">
        ...
        <div>
            <input type="text" name="tags" id="tags" placeholder="知識に関するタグをスペース区切りで5つまで入力" required>
        </div>
        <div>
            <textarea name="body" id="body" cols="30" rows="10" required>エンジニアに関わる知識をMarkdown記法で書いて共有しよう</textarea>
        </div>
